...
## This is not a library or a framework
...
You can use this project by cloning this repository and running `npm install` and `npm run dev` to start the development server. You can also use this project by visiting the [demo](https://donnisnoni.github.io/simple-form-builder).
